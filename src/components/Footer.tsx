        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Encontre seu imóvel ideal em todo o Brasil. Compra, venda e locação de imóveis residenciais e comerciais.
            </p>
          ...
          <div>
            <h3 className="text-lg font-heading font-semibold mb-4">Links Úteis</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center gap-2 text-gray-300">
                ...
                <span>contato@imoveisbr.com.br</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="mt-8 pt-6 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {currentYear} ImóveisBR. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
